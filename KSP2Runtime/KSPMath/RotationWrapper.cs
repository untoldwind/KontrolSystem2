...
namespace KontrolSystem.KSP.Runtime.KSPMath {
    public class RotationWrapper {
        ...
        /// <returns></returns>
        public static RotationWrapper FromVectorToVector(Vector v1, Vector v2) => new RotationWrapper(SimRotation.FromTo(v1, v2));
        ...
        public static RotationWrapper LookRotation(Vector lookDirection, Vector upDirection) => new RotationWrapper(SimRotation.LookRotation(lookDirection, upDirection));
        ...
        public static RotationWrapper AngleAxis(double degrees, Vector axis) =>
            new RotationWrapper(new Rotation(axis.coordinateSystem, QuaternionD.AngleAxis(degrees, axis.vector)));

        public static RotationWrapper operator *(RotationWrapper a, RotationWrapper b) => new RotationWrapper(new Rotation(a.rotation.coordinateSystem, a.rotation.localRotation * a.rotation.coordinateSystem.ToLocalRotation(b.rotation)));

        public static Vector operator *(RotationWrapper a, Vector b) => new Vector(a.rotation.coordinateSystem, a.rotation.localRotation * a.rotation.coordinateSystem.ToLocalVector(b));

        public static RotationWrapper operator +(RotationWrapper a, RotationWrapper b) => new RotationWrapper(new Rotation(a.rotation.coordinateSystem, QuaternionD.Euler(a.rotation.localRotation.eulerAngles + a.rotation.coordinateSystem.ToLocalRotation(b.rotation).eulerAngles)));
        ...
        public override bool Equals(object obj) {
            ...
            if (compareType.IsInstanceOfType(obj)) {
                RotationWrapper d = obj as RotationWrapper;
        ...
        public static bool operator ==(RotationWrapper a, RotationWrapper b) {
            Type compareType = typeof(RotationWrapper);
