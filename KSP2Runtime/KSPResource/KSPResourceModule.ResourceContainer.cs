...
public partial class KSPResourceModule {
    ...
    public class ResourceContainerAdapter {
        ...
        [KSField]
        public ResourceDataAdapter[] List => resourceContainer.GetAllResourcesContainedData()
            .Select(data => new ResourceDataAdapter(this, data)).ToArray();

        [KSField] public double StoredTotalMass => resourceContainer.GetStoredResourcesTotalMass();

        [KSField] public double StoredTotalThermalMass => resourceContainer.GetStoredResourcesTotalThermalMass();
