...
public partial class KSPConsoleModule {
    ...
    public static readonly RgbaColor WhiteColor = new(1.0, 1.0, 1.0);

    [KSConstant("BLACK", Description = "Color black")]
    public static readonly RgbaColor BlackColor = new(0.0, 0.0, 0.0);

    [KSConstant("RED", Description = "Color red")]
    public static readonly RgbaColor RedColor = new(1.0, 0.0, 0.0);

    [KSConstant("YELLOW", Description = "Color yellow")]
    public static readonly RgbaColor YellowColor = new(1.0, 1.0, 0.0);

    [KSConstant("GREEN", Description = "Color green")]
    public static readonly RgbaColor GreenColor = new(0.0, 1.0, 0.0);

    [KSConstant("CYAN", Description = "Color cyan")]
    public static readonly RgbaColor CyanColor = new(0.0, 1.0, 1.0);

    [KSConstant("BLUE", Description = "Color blue")]
    public static readonly RgbaColor BlueColor = new(0.0, 0.0, 1.0);

    [KSConstant("CONSOLE", Description = "Main console")]
    public static readonly Console MainConsole = new();
