...
public partial class KSPOABModule {
    ...
    public class ObjectAssemblyEngineAdapter(ObjectAssemblyPartAdapter part, Data_Engine dataSolarPanel) : BaseEngineAdapter<ObjectAssemblyPartAdapter, IObjectAssemblyPart>(part, dataSolarPanel) {
