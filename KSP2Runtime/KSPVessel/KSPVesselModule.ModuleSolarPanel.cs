...
public partial class KSPVesselModule {
    ...
    public class ModuleSolarPanelAdapter(PartAdapter part, Data_SolarPanel dataSolarPanel) : BaseSolarPanelAdapter<PartAdapter, PartComponent>(part, dataSolarPanel) {
