...
public partial class KSPUIModule {
    public abstract class AbstractContainer2D {
        ...
        [KSMethod]
        public Line2D AddLine(Vector2d[] points, KSPConsoleModule.RgbaColor strokeColor, bool closed = false,
        ...
        [KSMethod]
        public PixelLine2D AddPixelLine(Vector2d[] points, KSPConsoleModule.RgbaColor strokeColor,
            bool closed = false) {
        ...
        [KSMethod]
        public ValueRaster2D AddValueRaster(Vector2d point1, Vector2d point2, double[] values, long width, long height,
