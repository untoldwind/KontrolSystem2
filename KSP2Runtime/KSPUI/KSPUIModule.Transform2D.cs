...
namespace KontrolSystem.KSP.Runtime.KSPUI {
    public partial class KSPUIModule {
        public abstract class Transform2D : AbstractContainer2D, GLUIDrawer.IGLUIDrawable {
            ...
            protected override void RemoveAllElements() => elements.Clear();
        ...
        public class Translate2D : Transform2D {
            ...
            public Translate2D(Vector2d translate) : base(Matrix4x4.Translate(new Vector3((float)translate.x, (float)translate.y))) {
