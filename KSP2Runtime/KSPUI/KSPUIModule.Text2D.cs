...
public partial class KSPUIModule {
    ...
    public class Text2D : GLUIDrawer.IGLUIDrawable {
        public Text2D(Vector2d position, string text, double fontSize, Vector2d pivot, double degrees,
        ...
        [KSField] public Vector2d Position { get; set; }

        [KSField] public KSPConsoleModule.RgbaColor Color { get; set; }

        [KSField] public string Text { get; set; }

        [KSField] public double FontSize { get; set; }

        [KSField] public Vector2d Pivot { get; set; }

        [KSField] public double Degrees { get; set; }
