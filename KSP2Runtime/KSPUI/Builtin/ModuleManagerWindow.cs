    ...
    public class ModuleManagerWindow : UGUIResizableWindow {
        ...
        internal class EntrypointsUITab : UITab {
            ...
            internal void ShowParameterPopup(KontrolSystemProcessWithArguments element, Action onClose) {
                ...
                parameterPopup.Add(UGUILabel.Create(element.process.Name), UGUILayout.Align.Center).HorizontalAlignment = HorizontalAlignmentOptions.Center;
                ...
                for (int i = 0; i < element.argumentDescriptors.Length; i++) {
                    ...
                    if (element.argumentDescriptors[i].Type == BuiltinType.Bool) {
                        ...
                        if (element.argumentDescriptors[i].Type == BuiltinType.Int) {
                            var parameterInput = inputVertical.Add(UGUIInputField.Create("", 200, value => updateArgument(long.Parse(value))));
                            ...
                            var parameterInput = inputVertical.Add(UGUIInputField.Create("", 200, value => updateArgument(double.Parse(value))));
                            ...
                            var parameterInput = inputVertical.Add(UGUIInputField.Create("", 200, value => updateArgument(value)));
                ...
                var buttonHorizontal = parameterPopup.Add(UGUILayoutContainer.Horizontal(10, new UGUILayout.Padding(0, 0, 10, 10)));
            ...
            internal void OnProcessesChanged() {
                ...
                processList.Elements = Mainframe.Instance.AvailableProcesses.Select(process => new KontrolSystemProcessWithArguments(process, process.EntrypointArgumentDescriptors(gameMode))).ToArray();
        ...
        public class KontrolSystemProcessWithArguments {
            ...
            public KontrolSystemProcessWithArguments(KontrolSystemProcess process, EntrypointArgumentDescriptor[] argumentDescriptors) {
        ...
        internal class UIProcessElement : UIListElement<KontrolSystemProcessWithArguments> {
            ...
            private KontrolSystemProcessWithArguments element;
            ...
            public KontrolSystemProcessWithArguments Element => element;
        ...
        internal class UIModuleElement : UIListElement<ModuleListElement> {
            ...
            private ModuleListElement element;
            ...
            public UIModuleElement(ModuleListElement element, Action<IKontrolModule> onSelect) {
                ...
                selectButton = root.Add(UGUIToggle.CreateSelectButton(element.kontrolModule.Name, isOn => {
                    if (isOn) {
                        onSelect(element.kontrolModule);
                    }
            ...
            public ModuleListElement Element => element;
