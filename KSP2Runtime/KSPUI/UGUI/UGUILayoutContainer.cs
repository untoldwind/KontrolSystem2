...
namespace KontrolSystem.KSP.Runtime.KSPUI.UGUI {
    public class UGUILayoutContainer : UGUIElement {
        ...
        public E Add<E>(E element, UGUILayout.Align align = UGUILayout.Align.Stretch, float stretch = 0.0f) where E : UGUIElement {
        ...
        public static UGUILayoutContainer VerticalPanel(float gap = 10, UGUILayout.Padding padding = default) {
            ...
            var layout = new UGUIVerticalLayout(panel.GetComponent<RectTransform>(), gap, padding.Max(new UGUILayout.Padding(5, 5, 5, 5)));
        ...
        public static UGUILayoutContainer HorizontalPanel(float gap = 10, UGUILayout.Padding padding = default) {
            var panel = UIFactory.Instance.CreatePanel();
            var layout = new UGUIHorizontalLayout(panel.GetComponent<RectTransform>(), gap, padding.Max(new UGUILayout.Padding(5, 5, 5, 5)));
