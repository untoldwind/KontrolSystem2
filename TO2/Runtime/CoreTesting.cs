...
public class TestRunnerContext : IContext, ITO2Logger {
    ...
    public void Debug(string message) {
        messages.Enqueue("DEBUG: " + message);
    }

    public void Info(string message) {
        messages.Enqueue("INFO: " + message);
    }

    public void Warning(string message) {
        messages.Enqueue("WARNING: " + message);
    }
    ...
    public void IncrAssertions() {
        assertionsCount++;
    }

    public void IncrYield() {
        yieldCount++;
    }
}
...
public class CoreTesting {
    ...
    public static void TestSleep(long millis) {
