...
namespace KontrolSystem.TO2.AST {
    public static class BuiltinFunctions {
        private static readonly IKontrolFunction Some = new CompiledKontrolFunction("Some",
            ...
            new List<RealizedParameter> { new RealizedParameter("value", new GenericParameter("T"), "Value of the optional") },
        ...
        private static readonly IKontrolFunction Ok = new CompiledKontrolFunction("Ok",
            ...
            new List<RealizedParameter> { new RealizedParameter("value", new GenericParameter("T"), "Successful value") },
        ...
        private static readonly IKontrolFunction Err = new CompiledKontrolFunction("Err",
            ...
            new List<RealizedParameter> { new RealizedParameter("error", new GenericParameter("E"), "Error message") },
        ...
        private static readonly IKontrolFunction Cell = new CompiledKontrolFunction("Cell", "Wrap a value as cell",
            false, new List<RealizedParameter> { new RealizedParameter("value", new GenericParameter("T"), "Initial value of the cell") },
        ...
        private static readonly IKontrolFunction ArrayBuilder = new CompiledKontrolFunction("ArrayBuilder",
            ...
            new List<RealizedParameter> { new RealizedParameter("capacity", BuiltinType.Int, "Initial capacity of the array (does not affect the size of the array)", new IntDefaultValue(32)) },
